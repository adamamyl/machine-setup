...
while [[ $# -gt 0 ]]; do
    case "$1" in
        --help) cat <<EOF
Usage: $0 [--tailscale] [--pseudohome] [--docker] [--hwga] [--cloud-init] [--check-online] [--all-the-packages] [--all]
...
EOF
        ...
        --check-online) DO_CHECKONLINE=true ;; 
